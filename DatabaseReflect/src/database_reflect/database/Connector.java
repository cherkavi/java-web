...
import database_reflect.database.wrap.*;
...
public class Connector {
	...
	private java.lang.Class<?>[] classesOfDatabase=new java.lang.Class[]{
																		Cartridge_model.class,
																		Cartridge_vendor.class,
																		Order_group.class,
																		Order_list.class,
																		Point_settings.class,
																		Points.class
												   						};
	...
	public Connector() throws Exception{
		this("computer_shop_cartridge","SYSDBA","masterkey");
	}
...
*/
	...
	public Connector(String path) throws Exception {
		...
		this.hibernateConnection=new HibernateConnection("org.hibernate.dialect.FirebirdDialect",classesOfDatabase);
