...
@Scope("prototype")
@org.springframework.stereotype.Component("UploadDocuments")
public class UploadDocuments extends BpmTaskUi {
    @Override
    protected Component getRootComponent() {
        VerticalLayout layout = new VerticalLayout();
        layout.addComponent(new Label("UploadDocuments: "));
    ...
    protected void complete() {
        this.completeUserTask("UploadDocuments");
    }
