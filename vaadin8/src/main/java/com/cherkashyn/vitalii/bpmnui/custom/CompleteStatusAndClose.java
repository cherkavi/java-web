...
@Scope("prototype")
@org.springframework.stereotype.Component("CompleteStatusAndClose")
public class CompleteStatusAndClose extends BpmTaskUi {
    @Override
    protected Component getRootComponent() {
        VerticalLayout layout = new VerticalLayout();
        layout.addComponent(new Label("Name: CompleteStatusAndClose"));
