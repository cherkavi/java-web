...
public class ReadyForShipment extends BpmTaskUi {
    ...
    private ComboBox<String> orderReady;
    ...
    protected Component getRootComponent() {
        ...
        orderReady.setItems(Boolean.TRUE.toString(), Boolean.FALSE.toString());
    ...
    protected void complete() {
        if(!orderReady.getSelectedItem().isPresent()){
        ...
        this.completeUserTask("ReadyForShipment",
                ...
                ,new ImmutablePair<>("warehouseOrderReady", Boolean.parseBoolean(orderReady.getSelectedItem().get()))
        );
    }
