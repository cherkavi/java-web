...
public class AjaxFilterColumnDateBetween extends AbstractAjaxFilterColumnPanel implements IAjaxActionExecutor{
	...
	public int action(AjaxRequestTarget target, 
		...
		}if(name.equals(IAjaxActionExecutor.action_modal_cancel)){
