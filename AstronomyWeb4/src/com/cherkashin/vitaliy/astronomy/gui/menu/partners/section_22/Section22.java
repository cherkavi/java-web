package com.cherkashin.vitaliy.astronomy.gui.menu.partners.section_22;
...
/** ����������.���������������� ������� */
public class Section22 extends Panel implements IReportDoneListener {
	private final static long serialVersionUID = 1L;

	private IAjaxActionExecutor executor;

	/** ����������.���������������� ������� */
	public Section22(String id, IAjaxActionExecutor executor) {
		super(id);
	...
	private void initComponents() {
		...
		reportLink = new Link<Object>("report_link") {
			...
			public void onClick() {
				getRequestCycle().setRequestTarget(
						new ResourceStreamRequestTarget(new FileResourceStream(
								fullPathToGeneratedReport, "application/jpeg",
								Section22.this.getLocale()),
								"SmartConversation.jpeg"));
			}
		};
		...
		buttonBack.add(new SimpleAttributeModifier("value", this
		...
		buttonMenu.add(new SimpleAttributeModifier("value", this
				.getString("button_menu")));
	...
	private void onButtonExecute(AjaxRequestTarget target) {
		...
		try {
			AstronomyApplication application = (AstronomyApplication) this
					.getApplication();
			...
			double firstAngle = 0;
			firstAngle = algorithmAngle.getAngle(city.getLongitude(), city
					.getLatitude(), city.getGmt(), birthDayDate,
					PlanetName.Mercury);

			RithmSave saver = new RithmSave();
			saver.begin(connector, uniqueId);
			// ��������� ������
			new RightAlgorithm_Shag().executeShag(this.getDateBegin(), this
					.getDateEnd(), 1, city.getLongitude(), city.getLatitude(),
					city.getGmt(), firstAngle, PlanetName.Mercury, saver);
			...
			try {
				...
				application.getReporter().addReportForExecute(
						new ReportQueueElement(reportIdentifier,
								PatternReportList.reportRithmDay,
								"Интеллектуальное общение( "
										+ sdf.format(this.getDateBegin())
										+ ".." + sdf.format(this.getDateEnd())
										+ ") ", new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
				...
				System.err.println("Section22#onButtonExecute Exception:"
