package com.cherkashin.vitaliy.astronomy.gui.menu.partners.section_17;
...
/** ����������.���������� ��������� */
public class Section17 extends Panel implements IReportDoneListener{
	private final static long serialVersionUID=1L;
	
	private IAjaxActionExecutor executor;
	
	public Section17(String id, IAjaxActionExecutor executor){
		super(id);
	...
	private void onButtonExecute(AjaxRequestTarget target){
		...
		try{
			...
			double saturnAngle=algorithmAngle.getAngle(city.getLongitude(), city.getLatitude(), city.getGmt(), birthDayDate, PlanetName.Saturn);
			// ������� ������ �� ��������� ��� (-1 ���.. +2 ����; ��� - 10 ���� )
			...
			try{
				...
				application.getReporter().addReportForExecute(new ReportQueueElement(reportIdentifier, 
																					 PatternReportList.reportRithmMonth,
																					 "Длительные отношения( "+sdf.format(this.getDateBegin())+".."+sdf.format(this.getDateEnd())+") ",
																					 new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
				...
				System.err.println("Section17#onButtonExecute Exception:"+waitException.getMessage());
			}finally{
			...
			System.err.println("Section17#onButtonExecute Exception:"+ex.getMessage());
		}finally{
			try{
				connector.close();
			}catch(Exception ex){};
