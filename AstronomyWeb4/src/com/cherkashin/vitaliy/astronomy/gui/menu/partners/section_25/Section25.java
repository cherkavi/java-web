package com.cherkashin.vitaliy.astronomy.gui.menu.partners.section_25;
...
/** ���������� � �����������.���� ����� */
public class Section25 extends Panel implements IReportDoneListener{
	private final static long serialVersionUID=1L;
	
	private IAjaxActionExecutor executor;
	
	/** ���������� � �����������.���� ����� */
	public Section25(String id, IAjaxActionExecutor executor){
		super(id);
		...
		try{
			...
			try{
				...
				application.getReporter().addReportForExecute(new ReportQueueElement(reportIdentifier, 
																					 ...
																					 "Ритм вашего партнерства ( "+sdf.format(this.getDateBegin().getTime())+".."+sdf.format(this.getDateEnd().getTime())+") ",
																					 new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
