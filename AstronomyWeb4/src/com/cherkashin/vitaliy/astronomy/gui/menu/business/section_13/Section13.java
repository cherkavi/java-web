package com.cherkashin.vitaliy.astronomy.gui.menu.business.section_13;
...
/** ������ � �������.������� */
public class Section13 extends Panel implements IReportDoneListener{
	private final static long serialVersionUID=1L;
	
	private IAjaxActionExecutor executor;
	
	/** ������ � �������.������� */
	public Section13(String id, IAjaxActionExecutor executor){
		super(id);
		...
		reportLink=new Link<Object>("report_link"){
			...
			public void onClick() {
				getRequestCycle().setRequestTarget(new ResourceStreamRequestTarget(new FileResourceStream(fullPathToGeneratedReport,
						  																				  "application/jpeg",
						  																				  Section13.this.getLocale()
						  																				  ),
						  											               "BusinessCarrier.jpeg"
																					)
													);
			}
		};
		...
		try{
			...
			try{
				...
				application.getReporter().addReportForExecute(new ReportQueueElement(reportIdentifier, 
																					 ...
																					 "Карьера ( "+sdf.format(this.getDateBegin())+".."+sdf.format(this.getDateEnd())+") ",
																					 new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
