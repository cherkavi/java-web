package com.cherkashin.vitaliy.astronomy.gui.menu.partners.section_20;
...
/** ����������.����������� ���������*/
public class Section20 extends Panel implements IReportDoneListener{
	private final static long serialVersionUID=1L;
	
	private IAjaxActionExecutor executor;
	
	/** ����������.����������� ���������*/
	public Section20(String id, IAjaxActionExecutor executor){
		super(id);
		...
		try{
			...
			try{
				...
				application.getReporter().addReportForExecute(new ReportQueueElement(reportIdentifier, 
																					 ...
																					 "Сексуальные отношения ( "+sdf.format(this.getDateBegin())+".."+sdf.format(this.getDateEnd())+") ",
																					 new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
				...
				System.err.println("Section20#onButtonExecute Exception:"+waitException.getMessage());
			}finally{
			...
			System.err.println("Section20#onButtonExecute Exception:"+ex.getMessage());
		}finally{
			try{
				connector.close();
			}catch(Exception ex){};
