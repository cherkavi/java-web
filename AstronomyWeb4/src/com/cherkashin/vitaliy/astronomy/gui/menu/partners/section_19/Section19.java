package com.cherkashin.vitaliy.astronomy.gui.menu.partners.section_19;
...
/** ����������.������� ���������*/
public class Section19 extends Panel implements IReportDoneListener{
	private final static long serialVersionUID=1L;
	
	private IAjaxActionExecutor executor;
	
	/** ����������.������� ���������*/
	public Section19(String id, IAjaxActionExecutor executor){
		super(id);
		...
		try{
			...
			try{
				...
				application.getReporter().addReportForExecute(new ReportQueueElement(reportIdentifier, 
																					 PatternReportList.reportRithmHour,
																					 "Разовые отношения ( "+sdf.format(this.getDateBegin())+".."+sdf.format(this.getDateEnd())+") ",
																					 new Query(uniqueId)));
				// ������� �� ��������� ������� �� ���������
				...
				System.err.println("Section19#onButtonExecute Exception:"+waitException.getMessage());
			}finally{
			...
			System.err.println("Section19#onButtonExecute Exception:"+ex.getMessage());
		}finally{
			try{
				connector.close();
			}catch(Exception ex){};
