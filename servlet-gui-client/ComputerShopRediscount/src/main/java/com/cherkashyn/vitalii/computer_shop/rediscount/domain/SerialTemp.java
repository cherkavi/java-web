...
/**
 * SerialTemp generated by hbm2java
 */
@Entity
@Table(name = "SERIAL_TEMP")
public class SerialTemp implements java.io.Serializable {
	...
	public SerialTemp(int kod) {
		this.kod = kod;
	}

	public SerialTemp(int kod, String number, String numberSeller,
			Date dateWrite) {
		this.kod = kod;
		this.number = number;
